...
if (isset($_POST['deleteCustomerButton'])) {
    ...
    $sql1 = "DELETE FROM reservation WHERE GuestID = '$GuestID'";
    ...
    echo "</script>";
    echo "<script>window.location.href = 'delCust.php';</script>";
}
            ...
            <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
             ...
             <div class="w3-main" style="margin-left:250px">
                ...
                <header class="w3-container w3-xlarge">
                    <p class="w3-left">Delete Guest</p>
                    <p class="w3-right">
                    </p>
                </header>
                    ...
                    <table class="customer-table">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                <tr><td><?php echo htmlspecialchars($row["GuestID"]); ?></td>
                                ...
                                <td>
                                    <form method="POST" onsubmit="return confirm('Confirm to delete this guest?')">
                                    <input type="hidden" name="GuestID" value="<?php echo $row['GuestID']; ?>">
                                    <button type="submit" name="deleteCustomerButton" class="delete-btn"><i class="fa fa-trash"></i> Delete</button>
                                    </form>
                                </td></tr>
                            <?php endwhile; ?>    
                        </tbody>
